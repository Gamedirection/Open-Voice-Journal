...
export const createUser = (...args) => runStoreOperation("createUser", ...args);
export const getUserByEmail = (...args) => runStoreOperation("getUserByEmail", ...args);
export const getUserById = (...args) => runStoreOperation("getUserById", ...args);
export const touchUserLogin = (...args) => runStoreOperation("touchUserLogin", ...args);
export const updateUserStatus = (...args) => runStoreOperation("updateUserStatus", ...args);
export const updateUserRole = (...args) => runStoreOperation("updateUserRole", ...args);
export const updateUserPassword = (...args) => runStoreOperation("updateUserPassword", ...args);
export const listUsers = (...args) => runStoreOperation("listUsers", ...args);
export const createSession = (...args) => runStoreOperation("createSession", ...args);
export const getSessionByTokenHash = (...args) => runStoreOperation("getSessionByTokenHash", ...args);
export const revokeSessionByTokenHash = (...args) => runStoreOperation("revokeSessionByTokenHash", ...args);
export const revokeAllUserSessions = (...args) => runStoreOperation("revokeAllUserSessions", ...args);
export const countActiveAdmins = (...args) => runStoreOperation("countActiveAdmins", ...args);
export const countActiveAdminsExcludingUser = (...args) => runStoreOperation("countActiveAdminsExcludingUser", ...args);
export const getUserUsage = (...args) => runStoreOperation("getUserUsage", ...args);
export const upsertUserSetting = (...args) => runStoreOperation("upsertUserSetting", ...args);
export const listUserSettings = (...args) => runStoreOperation("listUserSettings", ...args);
export const upsertAppSetting = (...args) => runStoreOperation("upsertAppSetting", ...args);
export const getAppSetting = (...args) => runStoreOperation("getAppSetting", ...args);
export const listAppSettings = (...args) => runStoreOperation("listAppSettings", ...args);
export const insertAuditLog = (...args) => runStoreOperation("insertAuditLog", ...args);
export const createOpenApiKey = (...args) => runStoreOperation("createOpenApiKey", ...args);
export const listOpenApiKeysByUser = (...args) => runStoreOperation("listOpenApiKeysByUser", ...args);
export const getOpenApiKeyByHash = (...args) => runStoreOperation("getOpenApiKeyByHash", ...args);
export const touchOpenApiKeyLastUsed = (...args) => runStoreOperation("touchOpenApiKeyLastUsed", ...args);
export const revokeOpenApiKey = (...args) => runStoreOperation("revokeOpenApiKey", ...args);
export const listUserOwnedRecordings = (...args) => runStoreOperation("listUserOwnedRecordings", ...args);
export const hardDeleteUserAndData = (...args) => runStoreOperation("hardDeleteUserAndData", ...args);
export const assignUnownedRecordingsToUser = (...args) => runStoreOperation("assignUnownedRecordingsToUser", ...args);
